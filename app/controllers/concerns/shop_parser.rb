module ShopParser
 ...
 private
  def shop_fetch(url, host)
    ...
    # bay.ru
    @page.gsub!("<div class='with_coupon reveal-modal' id='fast_registration_modal'", "<div class='' id='' style='display:none !important'")
    @page.gsub!('<div class="reveal-modal-bg" style="display: block; cursor: pointer;"></div>', '<div class="reveal-modal-bg" style="display: none !important;"></div>')
    ...
    # otto.ru
    @page.gsub!("mousetrap","")
    @page.gsub!('<div class="ADSLeftDef">','<style>#mousetrap {display:none;}</style><div class="ADSLeftDef">')
